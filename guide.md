Thực hiện: Tạo project làm bài tập sau và up source code lên GitHub và nộp link github tại utexlms này:

Thực hiện nội dung bài tập 01 (24/06/2026) với công nghệ JPA API theo link sau: https://utexlms.hcmute.edu.vn/mod/page/view.php?id=1452205
https://utexlms.hcmute.edu.vn/mod/page/view.php?id=1452202

Hướng dẫn CRUD với JPA3.0 và Jakarta 6.0
...
2. Viết các phương thức tầng Dao
...
3. Viết các phương thức tầng Services
...
<!-- <persistence-unit name="jpa-hibernate-mysql">
 ...
 <property name="jakarta.persistence.jdbc.url" value="jdbc:mysql://localhost:3306/servletjpa" />
...
<property name="jakarta.persistence.jdbc.url" value="jdbc:sqlserver://localhost:1433;databaseName=jakartaJPA" />
...
Sửa lần cuối: Thứ Tư, 2 tháng 10 2024, 10:30 AM
